...
/codigo
/esp_principal -> Código da ESP32 principal (controle da esteira)
/esp_secundaria -> Código da ESP32 secundária (módulo adicional)
/clp_s7_1200 -> Programa do CLP Siemens S7-1200

/videos
validacao_clp_esp_tcpip.mp4
validacao_esp_esp_espnow.mp4
sistema_integral_funcionamento.mp4
